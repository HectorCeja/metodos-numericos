 ...
 * @author Héctor
 */
public class PanelSimpsonTabla extends javax.swing.JPanel {

    /**
     * Creates new form PanelSimpsonTabla
     */
    public PanelSimpsonTabla() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        add(jScrollPane2);
        jScrollPane2.setBounds(560, 120, 80, 180);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            //System.out.println(" Y \t M \t M*Y");
            valoresY.add(D.format(y[0]));
            valoresM.add(m[0]);
            valoresMY.add(D.format(m[0] * y[0]));
            // System.out.println(D.format(y[0])+"\t"+ m[0]+"\t"+ D.format(m[0]*y[0]));
            for (int i = 1; i < n - 1; i++) {
                valoresY.add(D.format(y[i]));
                valoresM.add(m[i]);
                valoresMY.add(D.format(m[i] * y[i]));
                //  System.out.println(D.format(y[i])+"\t"+m[i]+ "\t"+D.format(m[i]*y[i]));
            }
            valoresY.add(D.format(y[n - 1]));
            valoresM.add(m[n - 1]);
            valoresMY.add(D.format(m[n - 1] * y[n - 1]));
            // System.out.println(D.format(y[n-1])+"\t"+ m[n-1]+"\t"+ D.format(m[n-1]*y[n-1]));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            if (inco > 3 && inco % 2 == 0) {
                JOptionPane.showMessageDialog(null, "Puntos pares");
            } else {
